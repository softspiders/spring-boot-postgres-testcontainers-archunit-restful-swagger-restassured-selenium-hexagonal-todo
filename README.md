...
# ToDo starter service with hexagonal architecture on Spring Boot, PostgreSQL, Flyway, Swagger, Testcontainers, testing based on ArchUnit, REST Assured and Selenium
