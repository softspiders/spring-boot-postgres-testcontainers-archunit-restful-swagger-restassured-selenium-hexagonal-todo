 ...
 */
@AnalyzeClasses(packages = "org.softspiders.starters.todos", importOptions = ImportOption.DoNotIncludeTests.class)
...
public class ArchitectureTest {
    ...
    public static final ArchRule HEXAGONAL_ARCH_RULE = onionArchitecture()
            .domainModels("org.softspiders.starters.todos.domain.model..")
            .domainServices("org.softspiders.starters.todos.domain.port..")
            .adapter("crud", "org.softspiders.starters.todos.adapter.crud_jpa..")
            .applicationServices("org.softspiders.starters.todos.application..")
            .adapter("rest", "org.softspiders.starters.todos.adapter.rest..");
    ...
    public static final ArchRule PRIMARY_PORT_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.todos.application.service..")
            .and()
    ...
    public static final ArchRule SECONDARY_PORT_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.todos.adapter..")
            .and()
            ...
            .andShould()
            .dependOnClassesThat(resideOutsideOfPackage("org.softspiders.starters.todos.domain.port.spi.."));
    ...
    public static final ArchRule REST_DEPENDENCY_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.todos.adapter.rest..")
            .and()
            .haveSimpleNameEndingWith("Controller")
            .should()
            .dependOnClassesThat(resideInAPackage("org.softspiders.starters.todos.domain.port.api.."))
    ...
    private static class PrimaryPortArchCondition extends ArchCondition<JavaClass> {
        ...
        public void check(JavaClass clazz, ConditionEvents events) {
            ...
            Stream<JavaField> fieldStream = clazz.getFields().stream().filter(field -> field.getRawType().getPackageName().contains("org.softspiders.starters.todos.domain.port.spi"));
