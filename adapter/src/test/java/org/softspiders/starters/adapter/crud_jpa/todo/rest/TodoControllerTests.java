package org.softspiders.starters.adapter.crud_jpa.todo.rest;
...
public class TodoControllerTests {
    ...
    void shouldGetAllTodos() {
        ...
        given()
                ...
                .when()
                .get("/org/softspiders/starters/todos")
                .then()
                .statusCode(200)
                .body(".", hasSize(2));
    }
    ...
    void shouldGetTodoById() {
        ...
        given()
                .contentType(ContentType.JSON)
                .when()
                .get("/org/softspiders/starters/todos/{id}", todo.getId())
                .then()
                .statusCode(200)
    ...
    void shouldCreateTodoSuccessfully() {
        given()
                ...
                .when()
                .post("/org/softspiders/starters/todos")
                .then()
                .statusCode(201)
                .body("title", is("Todo Item 1"))
                .body("completed", is(false))
    ...
    void shouldDeleteTodoById() {
        ...
        given()
                .contentType(ContentType.JSON)
                .when()
                .delete("/org/softspiders/starters/todos/{id}", todo.getId())
                .then()
                .statusCode(200);
