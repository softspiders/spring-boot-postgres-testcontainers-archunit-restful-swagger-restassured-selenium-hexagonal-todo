 ...
 */
@AnalyzeClasses(packages = "org.softspiders.starters", importOptions = ImportOption.DoNotIncludeTests.class)
...
public class ArchitectureTest {
    ...
    public static final ArchRule HEXAGONAL_ARCH_RULE = onionArchitecture()
            ...
            .domainServices("org.softspiders.starters.domain.port..")
            .adapter("crud", "org.softspiders.starters.adapter.crud_jpa..")
            .applicationServices("org.softspiders.starters.application..")
            .adapter("rest", "org.softspiders.starters.adapter.rest..");
    ...
    public static final ArchRule PRIMARY_PORT_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.application.service..")
            .and()
    ...
    public static final ArchRule SECONDARY_PORT_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.adapter..")
            .and()
            ...
            .andShould()
            .dependOnClassesThat(resideOutsideOfPackage("org.softspiders.starters.domain.port.spi.."));
    ...
    public static final ArchRule REST_DEPENDENCY_ARCH_RULE = classes()
            .that()
            .resideInAPackage("org.softspiders.starters.adapter.rest..")
            .and()
            .haveSimpleNameEndingWith("Controller")
            .should()
            .dependOnClassesThat(resideInAPackage("org.softspiders.starters.domain.port.api.."))
    ...
    private static class PrimaryPortArchCondition extends ArchCondition<JavaClass> {
        ...
        public void check(JavaClass clazz, ConditionEvents events) {
            ...
            Stream<JavaField> fieldStream = clazz.getFields().stream().filter(field -> field.getRawType().getPackageName().contains("org.softspiders.starters.domain.port.spi"));
